...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Your Fitness | Diet Plans</title>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Diet Plans</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Diet Plans</span>
										</a>
									</li>
								</ul>
							</div>
                                            ...
                                            <div class="tab-pane active" id="m_widget5_tab1_content" aria-expanded="true">
                                                ...
                                                <div class="m-widget5">
                                                    <div class="m-widget5__item">
                                                        <div class="m-widget5__content">
                                                            <div class="m-widget5__pic">
                                                                <img class="m-widget7__img" src="{{asset('assets/meal1.jpg')}}" alt="">
                                                            </div>
                                                        ...
                                                        <div class="m-widget5__content">
                                                            <div class="m-widget5__stats1">
                                                                <span class="m-widget5__number">2400</span>
                                                                <br>
                                                                <span class="m-widget5__sales">Calories</span>
                                                            </div>
                                                            <div class="m-widget5__stats2">
                                                                <span class="m-widget5__number">7</span>
                                                                <br>
                                                                <span class="m-widget5__votes">Meals</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="m-widget5__item">
                                                        <div class="m-widget5__content">
                                                            <div class="m-widget5__pic">
                                                                <img class="m-widget7__img" src="{{asset('assets/meal2.png')}}" alt="">
                                                            </div>
                                                            <div class="m-widget5__section">
                                                                <h4 class="m-widget5__title">
                                                                    High Protein Diet
                                                        ...
                                                        <div class="m-widget5__content">
                                                            <div class="m-widget5__stats1">
                                                                <span class="m-widget5__number">2000</span>
                                                                <br>
                                                                <span class="m-widget5__sales">Calories</span>
                                                            </div>
                                                            <div class="m-widget5__stats2">
                                                                <span class="m-widget5__number">5</span>
                                                                <br>
                                                                <span class="m-widget5__votes">Meals</span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="m-widget5__item">
                                                        <div class="m-widget5__content">
                                                            <div class="m-widget5__pic">
                                                                <img class="m-widget7__img" src="{{asset('assets/meal3.jpg')}}" alt="">
                                                            </div>
                                                            <div class="m-widget5__section">
                                                                <h4 class="m-widget5__title">
                                                                    Beginner Bodybuilders Plans
                                                                </h4>
                                                                <span class="m-widget5__desc">
                                                        ...
                                                        <div class="m-widget5__content">
                                                            <div class="m-widget5__stats1">
                                                                <span class="m-widget5__number">2500</span>
                                                                <br>
                                                                <span class="m-widget5__sales">Calories</span>
                                                            </div>
                                                            <div class="m-widget5__stats2">
                                                                <span class="m-widget5__number">6</span>
                                                                <br>
                                                                <span class="m-widget5__votes">Meals</span>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane" id="m_widget5_tab2_content" aria-expanded="false">
                                                ...
                                                <div class="m-widget5">
                                                    <div class="m-widget5__item">
                                                        <div class="m-widget5__content">
                                                            <div class="m-widget5__pic">
                                                                <img class="m-widget7__img" src="{{asset('assets/meal4.jpg')}}" alt="">
                                                            </div>
                                                            <div class="m-widget5__section">
                                                                <h4 class="m-widget5__title">
                                                                    Healthy Meal Plan
                                                        ...
                                                        <div class="m-widget5__content">
                                                            <div class="m-widget5__stats1">
                                                                <span class="m-widget5__number">1500</span>
                                                                <br>
                                                                <span class="m-widget5__sales">Calories</span>
                                                            </div>
                                                            <div class="m-widget5__stats2">
                                                                <span class="m-widget5__number">4</span>
                                                                <br>
                                                                <span class="m-widget5__votes">Meals</span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="m-widget5__item">
                                                        <div class="m-widget5__content">
                                                            <div class="m-widget5__pic">
                                                                <img class="m-widget7__img" src="{{asset('assets/meal5.jpg')}}" alt="">
                                                            </div>
                                                            <div class="m-widget5__section">
                                                                <h4 class="m-widget5__title">
                                                                ...
                                                                <span class="m-widget5__desc">
                                                                    Long-term weight loss requires making healthier food choices on the regular. But if you are looking to lose weight and need some menu ideas, we haveve taken out the guesswork for you with this 1,200-calorie meal plan.
                                                                </span>
                                                                <div class="m-widget5__info">
                                                                    <span class="m-widget5__author">
                                                                        Added by:
                                                        ...
                                                        <div class="m-widget5__content">
                                                            <div class="m-widget5__stats1">
                                                                <span class="m-widget5__number">1200</span>
                                                                <br>
                                                                <span class="m-widget5__sales">Calories</span>
                                                            </div>
                                                            <div class="m-widget5__stats2">
                                                                <span class="m-widget5__number">3</span>
                                                                <br>
                                                                <span class="m-widget5__votes">Meals</span>
                                                            </div>
                                                        </div>
