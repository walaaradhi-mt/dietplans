...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Your Fitness | Workouts</title>
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Workouts</h3>
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Workouts</span>
										</a>
									</li>
								</ul>
							</div>
						...
						<div class="row">
                            <div class="col-md-6">
                                <div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
									...
									<div class="m-portlet__body">
                                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/fcN37TxBE_s" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
									</div>
								</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
                                    <div class="m-portlet__head">
                                        <div class="m-portlet__head-caption">
                                            <div class="m-portlet__head-title">
                                                ...
                                                <h3 class="m-portlet__head-text">
                                                    HIIT Cardio, Total Body Strength, Core Workout for 5 Million Subs!
                                                </h3>
                                                <h2 class="m-portlet__head-label m-portlet__head-label--accent">
                                                    <span>1000 Calorie Workout</span>
                                                </h2>
                                            </div>
                                        </div>
                                        <div class="m-portlet__head-tools">
                                    ...
                                    <div class="m-portlet__body">
                                        <iframe  width="100%" height="315" src="https://www.youtube.com/embed/I6pCg2MPr8k" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
                                    <div class="m-portlet__head">
                                        <div class="m-portlet__head-caption">
                                            <div class="m-portlet__head-title">
                                                ...
                                                <h3 class="m-portlet__head-text">
                                                    10 Minute Abs Workout - At Home Abs Workout with no Equipment
                                                </h3>
                                                <h2 class="m-portlet__head-label m-portlet__head-label--accent">
                                    ...
                                    <div class="m-portlet__body">
                                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/0fxhP9LFhDw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
                                    <div class="m-portlet__head">
                                        <div class="m-portlet__head-caption">
                                            <div class="m-portlet__head-title">
                                                ...
                                                <h2 class="m-portlet__head-label m-portlet__head-label--accent">
                                                    <span>Fitness Blender Abs Workout</span>
                                                </h2>
                                            </div>
                                        </div>
                                        <div class="m-portlet__head-tools">
                                    ...
                                    <div class="m-portlet__body">
                                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/0yZDVWab_dI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
                                    <div class="m-portlet__head">
                                        <div class="m-portlet__head-caption">
                                            <div class="m-portlet__head-title">
                                                ...
                                                <h2 class="m-portlet__head-label m-portlet__head-label--accent">
                                                    <span>All Strength Workout</span>
                                                </h2>
                                            </div>
                                        </div>
                                        <div class="m-portlet__head-tools">
                                    ...
                                    <div class="m-portlet__body">
                                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/bosWj6aPRBc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
                                    ...
                                    <div class="m-portlet__body">
                                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/T9AD9JB2rWQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
